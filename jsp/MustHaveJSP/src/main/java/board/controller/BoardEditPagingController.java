...
@WebServlet("/boardeditpaging.do")
public class BoardEditPagingController extends HttpServlet {
	...
	protected void doGet(HttpServletRequest req, HttpServletResponse resp) 
		...
		req.getRequestDispatcher("/12_2/EditResult.jsp").forward(req, resp);
	}
	...
	protected void doPost(HttpServletRequest req, HttpServletResponse resp) 
		...
		if (affected == 1) {
			resp.sendRedirect("boardviewpaging.do?num=" + num);
		} else {
