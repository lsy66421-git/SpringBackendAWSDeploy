			...
			<tr>
				<td colspan="4" align="center">
					<%if(session.getAttribute("UserId") != null
						...
						<button type="button" onclick="location.href='/MustHaveJSP/boardedit.do?num=${dto.num}';">수정하기</button>
						<button type="button" onclick="deletePost();">삭제하기</button>	
					<%} %>
					<button type="button" onclick="location.href='/MustHaveJSP/boardlist.do';">
						목록보기
					</button>
				</td>
			</tr>
