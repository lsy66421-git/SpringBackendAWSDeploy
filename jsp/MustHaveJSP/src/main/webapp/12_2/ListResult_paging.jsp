...
<body>
			...
			<c:when test="${ !(empty boardLists) }">
				...
				<c:forEach items="${boardLists}" var="dto">
					<tr align="center">
						<td>${virtualNum}</td> 
						<td align="left">
							<a href="${pageContext.request.contextPath}/boardviewpaging.do?num=${dto.num}&pageNum=${pageNum}">${dto.title}</a>
						</td>
    ...
    <table border="1" width="90%">
        <tr>
    		...
    		<td align="center"><button type="button" onclick="location.href='/MustHaveJSP/boardwritepaging.do';">글쓰기</button></td>
        </tr>
    </table>
</body>
</html>