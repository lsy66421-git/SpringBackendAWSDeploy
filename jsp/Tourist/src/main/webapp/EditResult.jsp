...
<html>
<head>
	<title> ${dto.title} | 공지사항 수정 | 고객센터 | 투어리스트인투어 </title>
	...
	<div id="container">
		...
		<div class="location_area customer">
			<div class="box_inner">
				...
				<p class="location">고객센터 <span class="path">/</span>공지사항<span class="path">/</span>수정하기</p>
            ...
            <form name="writeFrm" method="post" action="EditProcess.jsp" onsubmit="return validateForm(this);">
                ...
                <ul class="bbsview_list"> 
            	    <li class="bbs_title">제목 : 
						<input type="text" name="title" style="width: 500px; height: 30px; border: 1px solid black;" 
                               value="${dto.title}">	
					</li>
                    ...
                    <li class="bbs_content">
                        <div class="editer_content">
                            <textarea name="content" cols="127" rows="20">${dto.content}</textarea>
                        </div>
                    </li>
                </ul>             
             
                <p class="btn_line txt_right">
					<input type="submit" value="저장" class="btn_srch">
